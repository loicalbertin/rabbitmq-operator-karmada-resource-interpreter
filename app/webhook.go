...
import (
	...
	"github.com/loicalbertin/rabbitmq-operator-karmada-resource-interpreter/app/options"
)
...
func NewWebhookCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use: "rabbitmq-operator-karmada-resource-interpreter",
	...
	cmd.AddCommand(sharedcommand.NewCmdVersion("rabbitmq-operator-karmada-resource-interpreter"))
...
func Run(ctx context.Context, opts *options.Options) error {
	...
	hookServer.Register("/interpreter-rabbitCluster", interpreter.NewWebhook(&rabbitClusterInterpreter{}, interpreter.NewDecoder(gclient.NewSchema())))
