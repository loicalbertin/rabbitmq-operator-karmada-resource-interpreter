...
// 	// Suppose we want to retain the `.spec.paused` field of the actual observed rabbitCluster object in member cluster,
// 	// and prevent from being overwritten by karmada controller-plane.
// 	wantedRabbitCluster := desiredRabbit.DeepCopy()
// 	wantedRabbitCluster.Spec.Paused = observerRabbitCluster.Spec.Paused
...
// 	}
// 	wantedRabbitCluster.Status.ReadyReplicas = readyReplicas
// 	marshaledBytes, err := json.Marshal(wantedRabbitCluster)
// 	if err != nil {
// 		return interpreter.Errored(http.StatusInternalServerError, err)
// 	}
